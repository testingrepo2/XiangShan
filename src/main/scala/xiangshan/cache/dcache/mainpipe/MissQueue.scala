...
class MissReqPipeRegBundle(edge: TLEdgeOut)(implicit p: Parameters) extends DCacheBundle
 with HasCircularQueuePtrHelper
 {
  ...
  // def is_oldest_req: Bool = req_age_cmp_statue === 3.U
  // def is_older_req:  Bool = req_age_cmp_statue === 2.U
  // def is_newer_req:  Bool = req_age_cmp_statue === 1.U
  // def is_newest_req: Bool = req_age_cmp_statue === 0.U
}
